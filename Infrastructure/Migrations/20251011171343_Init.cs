    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSubjectExams", x => new { x.TeacherId, x.SubjectId, x.ExamId });
                    table.ForeignKey(
                        name: "FK_TeacherSubjectExams_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassAppointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassAppointments_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassAssets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassAssets_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSubjectExams", x => new { x.StudentId, x.SubjectId, x.ExamId });
                    table.ForeignKey(
                        name: "FK_StudentSubjectExams_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSubjectExams_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassAppointments_ClassId",
                table: "ClassAppointments",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassAssets_ClassId",
                table: "ClassAssets",
                column: "ClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionExamTeachers_ExamId",
                table: "QuestionExamTeachers",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionExamTeachers_TeacherId",
                table: "QuestionExamTeachers",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectExams_ExamId",
                table: "StudentSubjectExams",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectExams_SubjectId",
                table: "StudentSubjectExams",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjectExams_ExamId",
