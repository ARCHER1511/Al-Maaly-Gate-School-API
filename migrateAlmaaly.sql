...
VALUES (N'20260110151129_init', N'8.0.6');
GO
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Academics].[ClassAppointments]') AND [c].[name] = N'StartTime');
IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Academics].[ClassAppointments] DROP CONSTRAINT [' + @var0 + '];');
ALTER TABLE [Academics].[ClassAppointments] ALTER COLUMN [StartTime] datetimeoffset NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Academics].[ClassAppointments]') AND [c].[name] = N'EndTime');
IF @var1 IS NOT NULL EXEC(N'ALTER TABLE [Academics].[ClassAppointments] DROP CONSTRAINT [' + @var1 + '];');
ALTER TABLE [Academics].[ClassAppointments] ALTER COLUMN [EndTime] datetimeoffset NOT NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260122181241_Init34', N'8.0.6');
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Academics].[Exams]') AND [c].[name] = N'Start');
IF @var2 IS NOT NULL EXEC(N'ALTER TABLE [Academics].[Exams] DROP CONSTRAINT [' + @var2 + '];');
ALTER TABLE [Academics].[Exams] ALTER COLUMN [Start] datetimeoffset NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Academics].[Exams]') AND [c].[name] = N'End');
IF @var3 IS NOT NULL EXEC(N'ALTER TABLE [Academics].[Exams] DROP CONSTRAINT [' + @var3 + '];');
ALTER TABLE [Academics].[Exams] ALTER COLUMN [End] datetimeoffset NOT NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260125120724_Init23', N'8.0.6');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260125145853_Init11', N'8.0.6');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260125162818_InitialCreate', N'8.0.6');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260125163412_AddNewTables', N'8.0.6');
GO
