...
namespace Application.Services
{
    public class QuestionService : IQuestionService
    {
            ...
            switch (dto.Type)
            {
                case QuestionTypes.Complete:
                    if (dto.CorrectTextAnswer == null)
                        return ServiceResult<QuestionViewDto>.Fail(
                            "Correct Text are required for questions."
                        );
                    break;
                ...
                case QuestionTypes.Connection:
                    ...
                    var ConnectionChoices = dto
                        .Choices.Select(c => new Choices
                        {
        ...
        public async Task<ServiceResult<QuestionViewDto>> UpdateAsync(
            string id,
        ...
        )
        {
            ...
            return ServiceResult<QuestionViewDto>.Ok(
                _mapper.Map<QuestionViewDto>(question),
